...
PATHS=(
    ...
    "sd1234_20260125_074903:sd2345_20260125_074903:sd4567_20260125_074903:sd3456_20260125_074903"
...
for i in "${!TASK[@]}"; do
    ...
    # only run three seeds
    for j in {0..2}; do
        session_id="offon_puzzle_$((i*5+j+1))"
        ...
        COMMAND="python main.py --run_group=${TASK[$i]}_offon --env_name=${TASK[$i]} --offline_steps=500000 --online_steps=500000 --agent=agents/en_cfd_fql.py \
                    --agent.encoder=impala_small --p_aug=0.5 --frame_stack=3 --device_id=$((i+5)) \
                    --mujoco_device_id=$((i+2)) --agent.alpha=${ALPHA[$i]} \
